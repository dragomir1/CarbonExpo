  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.cardBodyInfo}>
          Fill out your payment Information for your future appointments. Not to
          worry, your Information is protected and safe with us.
        </Text>
